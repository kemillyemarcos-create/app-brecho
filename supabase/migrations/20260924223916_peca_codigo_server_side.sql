...
is 'Cria peça da empresa operacional autenticada com código curto gerado no servidor: prefixo configurável + custo inteiro + sufixo aleatório seguro de 6 caracteres.';
